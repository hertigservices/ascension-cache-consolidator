...
### `itemcache.wdb`  — 659,957 distinct records held
...
### `creaturecache.wdb`  — 28,799 distinct records held
...
### `gameobjectcache.wdb`  — 16,551 distinct records held
...
### `questcache.wdb`  — 23,058 distinct records held
...
### `npccache.wdb`  — 2,675 distinct records held
...
### `pagetextcache.wdb`  — 513 distinct records held
...
### `itemnamecache.wdb`  — 3,617 distinct records held
