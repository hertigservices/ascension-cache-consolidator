...
### `itemcache.wdb`  — 581,614 distinct records held
...
### `creaturecache.wdb`  — 20,140 distinct records held
...
### `gameobjectcache.wdb`  — 13,608 distinct records held
...
### `questcache.wdb`  — 20,240 distinct records held
...
### `npccache.wdb`  — 1,537 distinct records held
...
### `pagetextcache.wdb`  — 144 distinct records held
...
### `itemnamecache.wdb`  — 2,457 distinct records held
