...
### `itemcache.wdb`  — 657,788 distinct records held
...
### `creaturecache.wdb`  — 28,582 distinct records held
...
### `gameobjectcache.wdb`  — 16,501 distinct records held
...
### `npccache.wdb`  — 2,535 distinct records held
