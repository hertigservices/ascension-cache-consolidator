...
### `itemcache.wdb`  — 659,628 distinct records held
...
### `creaturecache.wdb`  — 28,765 distinct records held
...
### `gameobjectcache.wdb`  — 16,526 distinct records held
...
### `questcache.wdb`  — 23,040 distinct records held
...
### `npccache.wdb`  — 2,644 distinct records held
...
### `pagetextcache.wdb`  — 472 distinct records held
...
### `itemnamecache.wdb`  — 3,594 distinct records held
