...
### `itemcache.wdb`  — 644,135 distinct records held
...
### `creaturecache.wdb`  — 26,677 distinct records held
...
### `gameobjectcache.wdb`  — 15,876 distinct records held
...
### `questcache.wdb`  — 21,708 distinct records held
...
### `npccache.wdb`  — 2,179 distinct records held
...
### `pagetextcache.wdb`  — 330 distinct records held
...
### `itemnamecache.wdb`  — 3,319 distinct records held
