...
### `itemcache.wdb`  — 659,631 distinct records held
...
### `creaturecache.wdb`  — 28,769 distinct records held
...
### `gameobjectcache.wdb`  — 16,532 distinct records held
...
### `questcache.wdb`  — 23,050 distinct records held
...
### `npccache.wdb`  — 2,655 distinct records held
...
### `pagetextcache.wdb`  — 482 distinct records held
