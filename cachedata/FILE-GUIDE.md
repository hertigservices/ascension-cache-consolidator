...
### `itemcache.wdb`  — 582,538 distinct records held
...
### `creaturecache.wdb`  — 21,590 distinct records held
...
### `gameobjectcache.wdb`  — 13,999 distinct records held
...
### `questcache.wdb`  — 20,250 distinct records held
...
### `npccache.wdb`  — 1,742 distinct records held
...
### `pagetextcache.wdb`  — 172 distinct records held
...
### `itemnamecache.wdb`  — 2,501 distinct records held
