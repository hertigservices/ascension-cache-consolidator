...
### `itemcache.wdb`  — 653,584 distinct records held
...
### `creaturecache.wdb`  — 27,560 distinct records held
...
### `npccache.wdb`  — 2,456 distinct records held
...
### `pagetextcache.wdb`  — 403 distinct records held
