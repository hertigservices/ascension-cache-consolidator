...
### `itemcache.wdb`  — 647,554 distinct records held
...
### `creaturecache.wdb`  — 27,338 distinct records held
...
### `gameobjectcache.wdb`  — 16,016 distinct records held
...
### `questcache.wdb`  — 22,483 distinct records held
