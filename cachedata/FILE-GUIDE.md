...
### `itemcache.wdb`  — 642,917 distinct records held
...
### `creaturecache.wdb`  — 26,423 distinct records held
...
### `gameobjectcache.wdb`  — 15,676 distinct records held
...
### `questcache.wdb`  — 21,454 distinct records held
...
### `npccache.wdb`  — 2,026 distinct records held
...
### `pagetextcache.wdb`  — 272 distinct records held
...
### `itemnamecache.wdb`  — 2,951 distinct records held
