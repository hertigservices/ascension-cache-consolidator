...
### `itemcache.wdb`  — 659,976 distinct records held
...
### `creaturecache.wdb`  — 28,824 distinct records held
...
### `gameobjectcache.wdb`  — 16,553 distinct records held
...
### `questcache.wdb`  — 23,094 distinct records held
...
### `npccache.wdb`  — 2,679 distinct records held
