...
### `itemcache.wdb`  — 659,458 distinct records held
...
### `creaturecache.wdb`  — 28,732 distinct records held
...
### `npccache.wdb`  — 2,627 distinct records held
...
### `pagetextcache.wdb`  — 471 distinct records held
