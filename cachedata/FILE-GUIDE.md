...
### `itemcache.wdb`  — 642,435 distinct records held
...
### `creaturecache.wdb`  — 26,393 distinct records held
...
### `gameobjectcache.wdb`  — 15,662 distinct records held
...
### `questcache.wdb`  — 21,383 distinct records held
...
### `npccache.wdb`  — 2,008 distinct records held
...
### `pagetextcache.wdb`  — 220 distinct records held
...
### `itemnamecache.wdb`  — 2,934 distinct records held
