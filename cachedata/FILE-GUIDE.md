...
### `itemcache.wdb`  — 645,049 distinct records held
...
### `creaturecache.wdb`  — 26,858 distinct records held
...
### `gameobjectcache.wdb`  — 15,962 distinct records held
...
### `questcache.wdb`  — 22,021 distinct records held
...
### `npccache.wdb`  — 2,358 distinct records held
...
### `pagetextcache.wdb`  — 362 distinct records held
