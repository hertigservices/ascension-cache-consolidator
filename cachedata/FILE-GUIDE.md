...
### `itemcache.wdb`  — 659,296 distinct records held
...
### `creaturecache.wdb`  — 28,699 distinct records held
...
### `gameobjectcache.wdb`  — 16,520 distinct records held
...
### `questcache.wdb`  — 22,915 distinct records held
...
### `npccache.wdb`  — 2,572 distinct records held
