...
### `itemcache.wdb`  — 659,259 distinct records held
...
### `creaturecache.wdb`  — 28,690 distinct records held
...
### `questcache.wdb`  — 22,907 distinct records held
...
### `npccache.wdb`  — 2,567 distinct records held
