...
|---|---:|---:|---:|---:|---|
| `AscensionStockData.items` | 553,734 | 432,501 | 121,233 | 132 | `{ name, quality, icon, displayId, class, subclass, inventoryType, itemLevel, requiredLevel }` |
| `AscensionStockData.creatures` | 23,948 | 17,626 | 6,322 | 3 | `{ name, subname, displayId }` |
