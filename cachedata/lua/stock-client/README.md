...
|---|---:|---:|---:|---:|---|
| `AscensionStockData.items` | 553,716 | 432,331 | 121,385 | 132 | `{ name, quality, icon, displayId, class, subclass, inventoryType, itemLevel, requiredLevel }` |
| `AscensionStockData.creatures` | 23,854 | 17,588 | 6,266 | 3 | `{ name, subname, displayId }` |
