...
|---|---:|---:|---:|---:|---|
| `AscensionStockData.items` | 553,735 | 432,750 | 120,985 | 132 | `{ name, quality, icon, displayId, class, subclass, inventoryType, itemLevel, requiredLevel }` |
| `AscensionStockData.creatures` | 23,958 | 17,641 | 6,317 | 3 | `{ name, subname, displayId }` |
