...
|---|---:|---:|---:|---:|---|
| `AscensionStockData.items` | 553,740 | 432,780 | 120,960 | 132 | `{ name, quality, icon, displayId, class, subclass, inventoryType, itemLevel, requiredLevel }` |
| `AscensionStockData.creatures` | 23,977 | 17,693 | 6,284 | 3 | `{ name, subname, displayId }` |
