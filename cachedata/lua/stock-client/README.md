...
|---|---:|---:|---:|---:|---|
| `AscensionStockData.items` | 553,732 | 432,496 | 121,236 | 132 | `{ name, quality, icon, displayId, class, subclass, inventoryType, itemLevel, requiredLevel }` |
| `AscensionStockData.creatures` | 23,933 | 17,623 | 6,310 | 3 | `{ name, subname, displayId }` |
