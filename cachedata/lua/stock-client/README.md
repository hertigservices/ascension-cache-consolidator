...
|---|---:|---:|---:|---:|---|
| `AscensionStockData.items` | 553,740 | 432,820 | 120,920 | 132 | `{ name, quality, icon, displayId, class, subclass, inventoryType, itemLevel, requiredLevel }` |
| `AscensionStockData.creatures` | 23,978 | 17,696 | 6,282 | 3 | `{ name, subname, displayId }` |
